...
def extract_fund_code():
    res_txt = r'E:\dataset\test_分析1.txt'
    rootdir = r'E:\dataset\test'  # 待处理的数据文件夹
    # res_txt = r'E:\dataset\基金代码_res_24.txt'
    # rootdir = r'E:\dataset\基金代码_pro'  # 待处理的数据文件夹
    path_lists = get_all_path(rootdir)
    count = 0
    key_lists = ['国家自然学基金', '国家级自然科学', '国家自科科学', '国家自科学基金', '国家杰出青年基金', '国家自然学科', '国家科学基金', '国家青年基金', '国家自然科',
                 ...
                 'NSF China', 'National Scientific foundation of China', 'NSF of P.R.China', 'NSFC', 'NSF of China',
    ...
    for path in path_lists:
        ...
        with open(path, 'r', encoding=coding, errors='ignore') as rf, open(res_txt, 'a', encoding='utf-8',
            ...
            for line in rf:
                ...
                if line.startswith('<基金>=') and ((not line.startswith('<REC>'))):
                ...
                if file_content_flag == 1 and line.startswith('<REC>'):
                    ...
                    for ele in file_content_split:
                        if any(key.lower() in ele.lower() for key in key_lists):
                    ...
                    fund_code_res_1 = '<国家自然科学基金>=' + str(fund_code_res)
