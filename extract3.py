    ...
    with open(file_path, 'r', encoding=coding, errors='ignore')as f:
        ...
        for line in f:
            ...
            if file_name_flag == 1 and file_username_flag == 1 and file_content_flag == 1 and file_date_flag == 1:
                ...
                for e in re.finditer(email_pattern, file_content):  # e的返回结果为：<re.Match object; span=(336, 345), match='17@163.cn'>
                    e_res =e.group().strip()
                ...
                for p in re.finditer(phone_pattern, file_content):  # e的返回结果为：<re.Match object; span=(336, 345), match='17@163.cn'>
                    e_res = p.group().strip()
                ...
                for a in re.finditer(author_pattern, file_content):
                    a_ele = a.group().strip()
